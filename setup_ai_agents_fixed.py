...
from calls.models import Call, CallTemplate, CallQueue
        ...
        queue_entry, created = CallQueue.objects.get_or_create(
            ...
            defaults={
                ...
                'call_config': {
                    ...
                    'agent_name': template.conversation_flow.get('agent_name', 'AI Agent'),
...
def main():
    ...
    try:
        ...
        for template in templates:
            ...
            print(f"   • {agent_name} - {template.template_type} ({call_type})")
